...
import { ArrowLeft, CalendarDays, Download, MapPin, MoreHorizontal, UsersRound } from "lucide-react";
...
export default async function EventDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <MobileShell><main className="mobile-page">
    <header className="topbar"><Link href="/events" className="icon-button"><ArrowLeft size={19} /></Link><span className="eyebrow">Event detail</span><button className="icon-button"><MoreHorizontal size={20} /></button></header>
